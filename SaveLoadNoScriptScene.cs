...
public class SaveLoadNoScriptScene : Button {
  private static PackedScene _scenePrefab = GD.Load<PackedScene>("res://NoScriptScene.tscn");
  ...
  private void OnSaveLoadNoScriptScenePressed() {
